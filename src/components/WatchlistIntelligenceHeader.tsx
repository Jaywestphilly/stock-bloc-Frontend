...
export const WatchlistIntelligenceHeader: React.FC<WatchlistIntelligenceHeaderProps> = ({
  ...
  return (
    <div className="w-full space-y-3 px-4 py-2 font-martian">
      ...
      {/* Sort Controls Bar */}
      <div className="p-3 alien-block-cut bg-[#03111f] border border-cyan-900/60 space-y-2.5">
        <div className="flex items-center justify-between gap-2">
          ...
          <button
            ...
            className="w-full sm:w-auto px-3.5 py-2 alien-block-cut-sm bg-cyan-950/80 hover:bg-cyan-900/80 border border-cyan-500/40 text-cyan-300 text-xs font-alien-hud flex items-center justify-center gap-1.5 transition-all active:scale-95 cursor-pointer ml-auto"
        ...
        <div className="flex items-center gap-1.5 overflow-x-auto no-scrollbar pt-1 text-xs">
          <span className="text-cyan-500/70 text-[10px] font-alien-hud shrink-0 flex items-center gap-1">
          ...
          <button
            ...
            className={`px-2.5 py-1 alien-block-cut-sm text-[11px] font-alien-hud shrink-0 transition-all flex items-center gap-1 border ${
              sortField === "changePercent"
                ? "bg-cyan-500 text-black border-cyan-400 shadow-md glow-cyan"
